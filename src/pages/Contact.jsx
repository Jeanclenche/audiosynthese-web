...
export default function Contact() {
  return (
    <div>
      {/* Header section */}
      <section className="bg-[#f8f8f8] border-b border-gray-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 sm:py-32 text-center">
          ...
          <h1 className="font-display text-4xl sm:text-5xl lg:text-6xl font-normal tracking-tight text-[#333]">
            Contactez-nous
          </h1>
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-24 sm:py-32">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12">
            <div className="text-center">
              ...
              <p className="text-[#333] font-light">01 23 45 67 89</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-[#333] font-light">contact@audiosynthese.fr</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-[#333] font-light">Paris, France</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-[#333] font-light text-sm leading-relaxed">
                Lun - Ven : 10h - 19h<br />
                Sam : 10h - 18h
              </p>
            </div>
          ...
          <div className="mt-24 grid grid-cols-1 md:grid-cols-3 gap-12">
            <div className="border-t-2 border-gold/30 pt-8">
              <h3 className="font-display text-xl font-normal text-[#333] mb-3">Ecoute & Demonstration</h3>
            ...
            <div className="border-t-2 border-gold/30 pt-8">
              <h3 className="font-display text-xl font-normal text-[#333] mb-3">Commandes en ligne</h3>
              <p className="text-sm text-gray-400 font-light leading-relaxed">
            ...
            <div className="border-t-2 border-gold/30 pt-8">
              <h3 className="font-display text-xl font-normal text-[#333] mb-3">Service apres-vente</h3>
              <p className="text-sm text-gray-400 font-light leading-relaxed">
