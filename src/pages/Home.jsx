...
export default function Home() {
  ...
  return (
    <>
      ...
      <section className="bg-[#15120e] text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 sm:py-36 lg:py-44">
          <div className="max-w-3xl animate-fade-up">
            ...
            <h1 className="font-display text-5xl sm:text-6xl lg:text-7xl font-normal leading-[1.1] tracking-tight">
              L'excellence sonore
              <br />
              <span className="text-white/40">a portee de main</span>
            </h1>
            <p className="mt-8 text-lg font-light text-white/40 leading-relaxed max-w-xl animate-fade-up-delay">
              Decouvrez notre selection d'enceintes, amplificateurs, DAC et casques
              des plus grandes marques.
            </p>
            <p className="mt-4 font-display italic text-white/25 text-lg animate-fade-up-delay">
            ...
            <div className="mt-10 flex flex-wrap gap-4 animate-fade-up-delay-2">
              ...
              <Link
                to="/contact"
                className="inline-flex items-center gap-2 px-8 py-3.5 text-sm font-light uppercase tracking-widest text-white/40 border border-white/10 hover:text-white hover:border-white/30 transition-all duration-500"
              >
                Nous contacter
              </Link>
            </div>
      ...
      {/* Categories — pearl background */}
      <section className="bg-cream-dark">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 sm:py-32">
          <div className="text-center mb-16">
            <p className="text-[11px] text-gold font-light uppercase tracking-[0.3em] mb-4">Collections</p>
            <h2 className="font-display text-4xl sm:text-5xl font-normal text-charcoal tracking-tight">
              Nos univers
            </h2>
          </div>
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
            {categories.map(cat => (
              <Link
                ...
                className="group relative p-8 sm:p-10 text-center bg-cream-light border border-[#e5ddd0] hover:border-gold/30 transition-all duration-500"
              >
                ...
                <h3 className="font-display text-lg font-normal text-charcoal group-hover:text-gold-dark transition-colors duration-500">
                  {cat.label}
                </h3>
        ...
        <section className="bg-[#15120e]">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 sm:py-32">
            <div className="flex items-end justify-between mb-14">
              ...
              <Link
                to="/produits"
                className="hidden sm:inline-flex items-center gap-2 text-[11px] uppercase tracking-[0.15em] font-light text-white/40 hover:text-gold transition-colors duration-500"
              >
      ...
      <section className="bg-cream">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 sm:py-32 text-center">
          ...
          <h2 className="font-display text-4xl sm:text-5xl font-normal text-charcoal tracking-tight max-w-2xl mx-auto">
